    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <div className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <h1 className="text-4xl md:text-6xl font-serif text-white mb-4">About Laskarina</h1>
          <p className="text-gold-300 text-lg tracking-wide">Beauty & Elegance in Tangier</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            ...
            <div className="flex items-center gap-4 p-4 bg-zinc-900 rounded-xl border border-white/5 w-fit">
              <div className="flex -space-x-2">
                {[1, 2, 3].map(i => (
                  <div key={i} className="w-10 h-10 rounded-full bg-zinc-800 border-2 border-zinc-950 flex items-center justify-center text-xs text-white">
                    {i === 3 ? '100+' : ''}
                  </div>
                ))}
              </div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 bg-zinc-900 p-6 rounded-xl border border-white/10 shadow-xl max-w-xs">
              <div className="flex items-start gap-3 mb-4">
                <MapPin className="text-gold-500 shrink-0 mt-1" size={20} />
                <p className="text-zinc-300 text-sm">27 Av. Moulay Hicham, Tanger 90060</p>
              </div>
              <div className="flex items-center gap-3 mb-4">
                <Phone className="text-gold-500 shrink-0" size={20} />
                <p className="text-zinc-300 text-sm">06 12 46 50 64</p>
              </div>
              <div className="flex items-center gap-3">
                <Clock className="text-gold-500 shrink-0" size={20} />
                <p className="text-zinc-300 text-sm">Open daily until 9:00 PM</p>
              </div>
            </div>
          </motion.div>
        </div>

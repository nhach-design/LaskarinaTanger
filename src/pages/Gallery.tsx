  ...
  return (
    <div className="min-h-screen bg-zinc-950 py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="text-gold-400 text-sm uppercase tracking-[0.3em] mb-4 block">Portfolio</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map((img, idx) => (
            <motion.div
              ...
              className="group relative aspect-[3/4] overflow-hidden rounded-xl bg-zinc-900"
            >
              <img
                src={img.src}
                alt={img.alt}
